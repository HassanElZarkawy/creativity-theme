...
if ( ! function_exists( 'creativity_setup' ) ) :
	/**
	...
	function creativity_setup() {
		 ...
		 * If you're building a theme based on Creativity, use a find and replace
		 * to change 'creativity' to the name of your theme in all the template files.
		 */
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'creativity' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'creativity_custom_background_args', array(
...
function creativity_content_width() {
	...
	$GLOBALS['content_width'] = apply_filters( 'creativity_content_width', 1140 );
}
...
function creativity_scripts() {
	...
	wp_enqueue_style( 'mag-popup-css', get_template_directory_uri() . '/css/magnific-popup.css');
	wp_enqueue_style( 'font-awesome-css', get_template_directory_uri() . '/css/font-awesome.min.css');
	wp_enqueue_style( 'main-style-css', get_template_directory_uri() . '/css/style.css', array(), false);


	wp_enqueue_script( 'creativity-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );
	wp_enqueue_script( 'jquery-min', get_template_directory_uri() . '/js/jquery.min.js', array(), '20151215', false );
	...
	wp_enqueue_script( 'jquery-mag-popup', get_template_directory_uri() . '/js/jquery.magnific-popup.js', array(), '20151215', true );
	wp_enqueue_script( 'main-script-js', get_template_directory_uri() . '/js/main.js', array(), '20151215', true );

	wp_enqueue_script( 'creativity-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
...
/**
 * Register all the custom post types used.
 */
require get_template_directory() . '/inc/custom-post-types.php';

/**
 * Shortcodes used by the theme.
 */
